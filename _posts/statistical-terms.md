...
the values, or the square of the function that defines the continuous waveform. In the case of a set of n values {\displaystyle \{x_{1},x_{2},\dots ,x_{n}\}} \{x_{1},x_{2},\dots ,x_{n}\}, the RMS is
